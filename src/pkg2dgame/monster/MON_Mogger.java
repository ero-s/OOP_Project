...
public class MON_Mogger extends Entity {
    ...
    public void getImage() {
        up1 = setup("/pics/monsters/Mogger/up1.png", gp.tileSize, gp.tileSize);
        up2 = setup("/pics/monsters/Mogger/up2.png", gp.tileSize, gp.tileSize);
        left1 = setup("/pics/monsters/Mogger/left1.png", gp.tileSize, gp.tileSize);
        left2 = setup("/pics/monsters/Mogger/left2.png", gp.tileSize, gp.tileSize);
        right1 = setup("/pics/monsters/Mogger/right1.png", gp.tileSize, gp.tileSize);
        right2 = setup("/pics/monsters/Mogger/right2.png", gp.tileSize, gp.tileSize);
        down1 = setup("/pics/monsters/Mogger/down1.png", gp.tileSize, gp.tileSize);
        down2 = setup("/pics/monsters/Mogger/down2.png", gp.tileSize, gp.tileSize);
    }
